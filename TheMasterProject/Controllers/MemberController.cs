...
using TheMasterProject.Migrations;
...
namespace TheMasterProject.Controllers
{
    public class MemberController : Controller
    {
        ...
        public ActionResult UpdateDetails(int BuyerId)
        {
            ...
            var AppointmentDetails = db.AppointmentDetails.Where(x => x.BuyerId == BuyerId).FirstOrDefault();
            ...
            {
                buyer.AppointmentDate = AppointmentDetails.AppointmentDate;
                buyer.AppointmentTimeFromDb = AppointmentDetails.AppointmentTime;
            }
        ...
        public ActionResult UpdateDetails(BuyerDetailViewModel bv)
        {
            ...
            try
            {
                ...
                return RedirectToAction("UpdateDetails", bv.BuyerId);
            }
            catch(Exception ex)
            {
                return View("Error");
        ...
        public ActionResult ViewBuyersForDocumentUpload()
        {
            var userid = GetUserId();
            var leadDeatils = db.BuyerRelation.Include("BuyerDetail").Where(x => x.MemberId == userid).ToList();
        ...
        public ActionResult UpdateFileDetails(int BuyerId)
        {
            var buyerFileDetails = db.BuyerDocuments.Where(x => x.BuyerId == BuyerId).FirstOrDefault();

            var buyer = new BuyerDocumentUploadViewModel
                {
                    BuyerId = buyerFileDetails.BuyerId,
                    PassportCopy = buyerFileDetails.PassportCopy,
                    DrivingLicenceWithDob = buyerFileDetails.DrivingLicenceWithDob,
                    VotersId = buyerFileDetails.VotersId,
                    ElectricityBill = buyerFileDetails.ElectricityBill,
                    TelephoneBill = buyerFileDetails.TelephoneBill,
                    LeaveLicenceAggrCopy = buyerFileDetails.LeaveLicenceAggrCopy,
                    CompanyAccoLetter = buyerFileDetails.CompanyAccoLetter,
                    OtherBankStatmnt = buyerFileDetails.OtherBankStatmnt,
                    TelephoneProof = buyerFileDetails.TelephoneProof,
                    AadharCardCopy = buyerFileDetails.AadharCardCopy,
                    AddressProofDetailId = buyerFileDetails.AddressDetailId,
                    //Application Form Details
                    ApplicationFormImaging = buyerFileDetails.ApplicationFormImaging,
                    ApplicationFormDetailId = buyerFileDetails.ApplicationFormDetailId,
                    //Income Proof
                    Form16 = buyerFileDetails.Form16,
                    AppointmentLetter = buyerFileDetails.AppointmentLetter,
                    SalarySlip = buyerFileDetails.SalarySlip,
                    Itr = buyerFileDetails.Itr,
                    GstCertification = buyerFileDetails.GstCertification,
                    IncomeProofDetailId = buyerFileDetails.IncomeProofDetailId,
                    //Bank Statement
                    BankStatementDetailId = buyerFileDetails.BankStatementDetailId,
                    BankStatementLatestSixMonths = buyerFileDetails.BankStatementLatestSixMonths,
                    BankStatmentThreeMonths = buyerFileDetails.BankStatmentThreeMonths,
                    BankStatementYear = buyerFileDetails.BankStatementYear,
                    //Identity Proof
                    VotersIdCard = buyerFileDetails.VotersIdCard,
                    IdentityProofDetailId = buyerFileDetails.IdentityProofDetailId,
                    //Profile Documents
                    PanCardId = buyerFileDetails.PanCardId,
                    ProfilePhoto = buyerFileDetails.ProfilePhoto,
                    ProfileDocumentDetailId = buyerFileDetails.ProfileDocumentDetailId,
                };
            ...
            return View("UpdateFileDetails", buyer);
        }
        ...
        [HttpPost]
        public ActionResult BookAppointment(BuyerDetailViewModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var currentAppointment = db.AppointmentDetails.Where(x => x.BuyerId == model.BuyerId).FirstOrDefault();
                    if(currentAppointment != null)
                    {
                        currentAppointment.AppointmentDate = model.AppointmentDate;
                        currentAppointment.AppointmentTime = model.AppointmentTime;
                    }
                    else
                    {
                        ...
                        db.AppointmentDetails.Add(newappointment);
                    }
